                ...
                <nav className="ms-sm-5 navbar navbar-expand-sm px-2">
                    ...
                    <div className={`collapse navbar-collapse ${isMenuOpen ? 'show' : ''}`} id="navbarContent">
                        <div className="navbar-nav">
                            <Link className="nav-link active mx-md-2" aria-current="page" to="/" onClick={handleLinkClick}>{t('header.home')}</Link>
                            <Link className="nav-link mx-md-2" to="aboutMe" onClick={handleLinkClick}>{t('header.aboutMe')}</Link>
                            <Link className="nav-link mx-md-2" to="aboutBritMilah" onClick={handleLinkClick}>{t('header.aboutBritMilah')}</Link>
                            <Link className="nav-link mx-md-2" to="costs" onClick={handleLinkClick}>{t('header.costs')}</Link>
                            <Link className="nav-link mx-md-2" to="contact" onClick={handleLinkClick}>{t('header.contact')}</Link>
                        </div>
                    </div>
                </nav>
            </div>
